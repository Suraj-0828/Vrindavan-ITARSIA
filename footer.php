  ...
  <footer class="footer bg-[#EEEEEE] pt-10 font-normal bg-no-repeat" style="background-image: url('assets/images/footer/pattern.png');">
              ...
              <div class="col-md-3">
                  ...
                  <ul class="inline-flex items-center justify-center mt-[20px]">
                      <li class="first:ml-0 ml-[15px]">
                          <a href="https://www.facebook.com/" aria-label="svg" class="w-[22px] h-[22px] transition-all rounded-full bg-black flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-white hover:bg-secondary">
                      ...
                      <li class="ml-[15px]">
                          <a href="https://twitter.com/" aria-label="svg" class="w-[22px] h-[22px] transition-all rounded-full bg-black flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-white hover:bg-secondary">
                      ...
                      <li class="ml-[15px]">
                          <a href="https://www.instagram.com/" aria-label="svg" class="w-[22px] h-[22px] transition-all rounded-full bg-black flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-white hover:bg-secondary">
      ...
      <div style="margin-bottom: -100px;" class="row text-center mr-auto mt-10">
          ...
          <span class="copyrights-text"> Copyright ©
              ...
              </script>  <span class="text-dark">Vrindavan</span>, All Rights and Reserved. Powered by <a href="https://www.itarsia.com/" target="_blank"> Itarsia India Limited</a>
            </span>
          </div>
      </div>
  </footer>
  ...
  <a href="tel:919099909968" target="_blank" class="phone">
      <img src="assets/images/icon/phone-icon.png" class="my-float1" alt="">
  </a>
  </div>
