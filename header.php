                     ...
                     <nav class="flex flex-wrap items-center">
                         <ul class="hidden lg:flex flex-wrap items-center font-lora text-[16px] xl:text-[18px] leading-none text-black">
                             <li class="mr-7 xl:mr-[40px] relative group py-[20px]">
                                 ...
                                 <a href="#home" style="font-size: 25px;" class="transition-all text-black hover:text-secondary">Home</a>


                             </li>
                             <li class="mr-7 xl:mr-[40px] relative group py-[20px]">

                                 <a href="#about" style="font-size: 25px;" class="transition-all text-black hover:text-secondary">About us</a>
                             ...
                             <li class="mr-7 xl:mr-[40px] relative group py-[20px]">
                                 ...
                                 <a href="#amenities" style="font-size: 25px;" class="transition-all text-black hover:text-secondary">Amenities</a>

                             </li>

                             <li class="mr-7 xl:mr-[40px] relative group py-[20px]">

                                 <a href="#nearby" style="font-size: 25px;" class="transition-all text-black hover:text-secondary">Near by</a>


                             </li>
                             <li class="mr-7 xl:mr-[40px] relative group py-[20px]">

                                 <a href="#contact" style="font-size: 25px;" class="transition-all text-black hover:text-secondary">Contact</a>
     ...
     <div class="py-12 pr-5 h-[100vh] overflow-y-auto">
         ...
         <nav class="offcanvas-menu mr-[20px]">
             <ul>
                 ...
                 <li class="relative block border-b-primary border-b"><a href="#contact" class="relative block capitalize text-black hover:text-secondary text-base my-2 py-1 px-5">Contact</a>
                 </li>
             </ul>
         </nav>
         <!-- offcanvas-menu end -->
